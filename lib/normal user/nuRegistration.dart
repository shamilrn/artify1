...
class nuReg extends StatefulWidget {
  const nuReg({super.key});

  @override
  State<nuReg> createState() => _nuRegState();
}

class _nuRegState extends State<nuReg> {
  @override
                        ...
                        children: [
                          ...
                          Container(
                            ...
                            child: ElevatedButton(onPressed: (){
                              Navigator.pushReplacement(context, MaterialPageRoute(builder: (context)=> normalUserLogin()
                              ),
                              );
                            },
                              style: ElevatedButton.styleFrom(
